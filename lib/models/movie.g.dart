...
const MovieSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'originCountries': PropertySchema(
      id: 3,
      name: r'originCountries',
...
void _movieSerialize(
  ...
  writer.writeStringList(offsets[3], object.originCountries);
  ...
  writer.writeDouble(offsets[13], object.voteCount);
}
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originCountriesIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'originCountries',
      ));
    });
  }

  QueryBuilder<Movie, Movie, QAfterFilterCondition> originCountriesIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'originCountries',
      ));
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementContains(String value,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'originCountries',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'originCountries',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'originCountries',
        value: '',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'originCountries',
        length,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> originCountriesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'originCountries',
        0,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition>
      originCountriesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByTmdbId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tmdbId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByTmdbIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByTmdbId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tmdbId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByTmdbIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tmdbId', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByOriginCountries() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'originCountries');
    });
  }
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByTmdbId() {
    return QueryBuilder.apply(this, (query) {
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, List<String>?, QQueryOperations>
      originCountriesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'originCountries');
    });
  }
