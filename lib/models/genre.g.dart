...
Genre _genreDeserialize(
  ...
  final object = Genre(
    ...
    tmdbId: reader.readLongOrNull(offsets[1]),
  );
  return object;
}
...
extension GenreQueryFilter on QueryBuilder<Genre, Genre, QFilterCondition> {
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'tmdbId',
      ));
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'tmdbId',
      ));
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'tmdbId',
        value: value,
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Genre, Genre, QAfterFilterCondition> tmdbIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
